...
export default function App() {
  ...
  //call localStorageState hook
  // useLocalStorageState(initialVallue,key)
...
function SelectedMovie({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  function handleAdd() {
    const newWatchedMovie = {
      ...
      Year: movie.Year,
      Poster: movie.Poster,
      imbdRating: Number(movie.imbdRating),
  ...
  // effect to change the page title
  useEffect(
    function () {
  ...
  //effect to addeventlistner to escape key
  // call our useKey hook
